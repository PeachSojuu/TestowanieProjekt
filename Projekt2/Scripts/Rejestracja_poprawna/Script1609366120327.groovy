...
WebUI.setText(findTestObject('Object Repository/Page_Login - My Store/input__customer_firstname'), findTestData('Dane2').getValue(
        1, 1))

// Wprowadzenie poprawnych danych w pole "Last Name" pobieranych z Pliku (DATA FIILE) przez program

WebUI.setText(findTestObject('Object Repository/Page_Login - My Store/input__customer_lastname'), findTestData('Dane2').getValue(
        1, 2))

// Wprowadzenie poprawnych danych w pole "Password" pobieranych z Pliku (DATA FIILE) przez program

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login - My Store/input__passwd'), findTestData('Dane2').getValue(
        1, 3))

// Wprowadzenie poprawnych danych w pole "Address" pobieranych z Pliku (DATA FIILE) przez program

WebUI.setText(findTestObject('Object Repository/Page_Login - My Store/input__address1'), findTestData('Dane2').getValue(
        1, 4))

// Wprowadzenie poprawnych danych w pole "City" pobieranych z Pliku (DATA FIILE) przez program

WebUI.setText(findTestObject('Object Repository/Page_Login - My Store/input__city'), findTestData('Dane2').getValue(1, 5))
...
WebUI.setText(findTestObject('Object Repository/Page_Login - My Store/input__postcode'), findTestData('Dane2').getValue(
        1, 6))

// Wprowadzenie poprawnych danych w pole "Mobile phone" pobieranych z Pliku (DATA FIILE) przez program

WebUI.setText(findTestObject('Page_Login - My Store/input__phone_mobile'), findTestData('Dane2').getValue(1, 7))


WebUI.click(findTestObject('Object Repository/Page_Login - My Store/div_Create an accountYour personal informat_4721ab'))

// Wprowadzenie poprawnych danych w pole "Assign an address alias for future reference" pobieranych z Pliku (DATA FIILE) przez program

WebUI.setText(findTestObject('Object Repository/Page_Login - My Store/input__alias'), findTestData('Dane2').getValue(1, 
        8))

// Wcisniecie przycisku "Register" w celu ukonczenia i zalozenia nowego konta w serwisie
